...
import { getLazySectionComponent } from './sectionRegistry'
...
function ProductSection({ section }) {
  const Component = useMemo(() => {
    ...
    if (section.type === 'custom') {
      return section.loader ? getCustomComponent(section.loader) : null
    }

    return getLazySectionComponent(section)
  }, [section])
  ...
  const content = (
    <Suspense fallback={<div className="section-error">Loading section: {section.type}</div>}>
